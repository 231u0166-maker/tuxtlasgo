...
export default function AppShell() {
  ...
  const [mostrarAuth, setMostrarAuth] = useState(registroDesdeUrl);
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row bg-jungle-50 h-screen [height:100dvh] overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 min-h-0 overflow-hidden">
        ...
        {/* Burbuja de notificaciones — solo dentro de /app (las 5
            pestañas: inicio/explorar/asistente/mis lugares/perfil),
            no en Comunidad, Galería ni la landing. */}
