...
export default function NotificacionesBurbuja() {
  ...
  return (
    ...
    >
      {abierta && (
        <div
          className={`absolute w-80 max-w-[85vw] bg-white rounded-2xl shadow-2xl border border-jungle-100 overflow-hidden ${
            enMitadInferior ? 'bottom-full mb-3' : 'top-full mt-3'
